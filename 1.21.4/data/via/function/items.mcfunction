...
give @s stick[equippable={slot:"feet", equip_sound:"ambient.cave", asset_id:"gold", camera_overlay:"item/pumpkin_seeds", allowed_entities:["player"], dispensable:true, swappable:true, damage_on_hurt:false}]
...
give @s stick[trim={material:{asset_name:"amethyst", description:"Description", ingredient:"acacia_boat", override_armor_materials:{chainmail:"override_material"}}, pattern:"bolt", show_in_tooltip:true}]
