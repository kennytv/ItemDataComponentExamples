...
give @s stick[equippable={slot:"feet", equip_sound:"ambient.cave", model:"gold", camera_overlay:"item/pumpkin_seeds", allowed_entities:["player"], dispensable:true, swappable:true, damage_on_hurt:false}]
